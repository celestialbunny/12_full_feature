...
def register():
	if current_user.is_authenticated:
		flash('You have already logged in using your registered account, log out if you want to sign in using another account', 'warning')
...
def update_post(post_id):
	...
	if form.validate_on_submit():
		...
		# no adding to db needed as this operation only 'updates'
		# as the 'entry' is already there
		db.session.commit()
